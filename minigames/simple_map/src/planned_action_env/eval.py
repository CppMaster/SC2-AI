...
def main() -> None:
    """
    Main evaluation function for the PlannedActionEnv.
    
    This function loads a trained model and runs evaluation episodes
    ...
    # Initialize environment with evaluation configuration
    ...
    # Wrap environment with observation stacking
