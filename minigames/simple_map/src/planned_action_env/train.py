...
suffix = "init_diff-medium"
output_path = f"minigames/simple_map/results/planned_action_logs/{suffix}"

env = PlannedActionEnv(step_mul=4, difficulty=Difficulty.medium)
...
model = MaskablePPO(
    ...
    batch_size=64, learning_rate=5e-6, normalize_advantage=True, n_steps=1200
)
