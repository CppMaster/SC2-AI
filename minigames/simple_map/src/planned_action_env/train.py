...
def main() -> None:
    """
    Main training function for the PlannedActionEnv.
    
    This function sets up the environment, reward shapers, and training model,
    ...
    # Uncomment to use reward shapers
    ...
    # Uncomment to use observation stacking wrapper
